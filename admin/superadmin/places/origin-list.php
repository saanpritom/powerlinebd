                    ...
                    <div class="card">
                                ...
                                <tbody>
                                  <?php
                                    ...
                                    $query = "SELECT `o_id_id`, `full_name`, `short_form`
                                              FROM `origin_destination_details` WHERE `type`='origin' ORDER BY `full_name` ASC LIMIT 20 OFFSET $low_point";
                        ...
                        <div class="body">
                          <?php
                            ...
                            $query = "SELECT COUNT(sl_num) AS total_id FROM origin_destination_details WHERE `type`='origin'";
                        ...
                        <div class="body">
                           ...
                           $show_pagination->do_pagination('origin-list');
