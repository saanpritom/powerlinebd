                                ...
                                <div class="form-group">
                                  <select class="form-control show-tick" name="organization_id">
                                      ...
                                      <?php
                                        ...
                                        $query = "SELECT consignee_id, name FROM consignee_details ORDER BY name ASC";
                                        $result = $get_contact->getData($query);

                                        foreach ($result as $key => $res)
                                        {
                                          if($res['consignee_id'] == $parent_organization_id){

                                            ?>
                                            <option value="<?php echo $res['consignee_id']; ?>" selected="selected"><?php echo $res['name']; ?></option>
                                            <?php
