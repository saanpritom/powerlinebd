                          ...
                          if($msg != null){
                            ...
                            if($new_branch == 'Successfully created a new branch'){
                              ...
                              <div class="alert bg-green">
                                  <?php echo 'Successfully created a new branch'; ?>
                              </div>
                              <?php
                            }else{
                              ?>
                        ...
                        <div class="body">
                            <form action="create-branch" method="POST">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="name" class="form-control" required aria-required="true" placeholder="Enter branch name here" name="branch_name">
                                    </div>
                                </div>
                                <label for="email_address">Email Address</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="email" id="email_address" class="form-control" placeholder="Enter email address" name="email_address">
                                    </div>
                                </div>
