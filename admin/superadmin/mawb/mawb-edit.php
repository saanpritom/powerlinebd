                    ...
                    <div class="body">
                      ...
                      <?php
                          ...
                          if($msg != null){
                            ...
                            $new_mawb = $mawb_operation->update_mawb($mawb_id, $mawb_number, $user_id);

                            //check if branch created properly;
                            if($new_mawb == 'MAWB updated Successfully'){
                              ?>
                              <div class="alert bg-green">
                                  <?php echo 'MAWB updated Successfully'; ?>
                              </div>
                              <?php
                            }else{
                              ?>
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                          <?php
                            ...
                            $result = $mawb_operation->getData($query);
                          ...
                          ?>
                            <form action="<?php echo $mawb_id; ?>" method="POST">
                                <label for="flight_name">MAWB Number</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="mawb_name" class="form-control" required aria-required="true" placeholder="Enter MAWB number here" name="mawb_number" value="<?php echo $mawb_number; ?>">
                                    </div>
                                </div>
                                <br>
