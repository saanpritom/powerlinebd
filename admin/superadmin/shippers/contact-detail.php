                        ...
                        <div class="header">
                          ...
                          ?>
                            ...
                            <div style="text-align: right;">
                              <a href="/powerlinebd/admin/superadmin/shippers/contact-edit/<?php echo $contact_id; ?>" type="button" class="btn bg-blue waves-effect">Edit</a>
                                          ...
                                          <tbody>
                                            ...
                                            <?php
                                              ...
                                              $query = "SELECT contact_person_details.person_from, contact_person_details.parent_organization_id,
                                                        ...
                                                        login_info.email, shipper_details.name AS s_name, creation_details.creation_date, creation_details.creation_time
                                                        FROM contact_person_details INNER JOIN login_info
                                                        ON contact_person_details.contact_id=login_info.user_id INNER JOIN shipper_details
                                                        ON contact_person_details.parent_organization_id=shipper_details.shipper_id INNER JOIN creation_details
                                              ...
                                              foreach($result as $key => $res){
                                                ...
                                                <tr>
                                                  ...
                                                  <th><?php echo 'Shipper'; ?></th>
                                                </tr>

                                                <tr>
                                                  <th>3</th>
                                                  <th>Oranization Name</th>
                                                  <th><a href="/powerlinebd/admin/superadmin/shippers/shipper-detail/<?php echo $res['parent_organization_id']; ?>/1"><?php echo $res['s_name']; ?></a></th>
                                                </tr>
